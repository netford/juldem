...
const steps = [
  {
    ...
    icon: MessageSquare,
    items: [
      'Обсуждаем ваши требования и пожелания к функциональности и дизайну',
      'Согласовываем сроки, бюджет и предварительный эскиз',
      'Подтверждаем заказ и, после получения предоплаты, приступаем к работе',
      'Предоставляем возможность уточнения деталей на любом этапе работы'
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    items: [
      ...
      'Проводим примерку и, при необходимости, финальные корректировки'
    ]
  },
  {
    id: 4,
