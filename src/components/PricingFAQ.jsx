...
const PricingFAQ = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Да, для начала работы над индивидуальным заказом требуется предоплата в размере от 2 000 до 5 000 руб.\n\nПредоплата не возвращается, даже в случае отказа от заказа на более поздних этапах, так как раскроенные детали уже не могут быть использованы для других клиентов. Это необходимое условие для изготовления костюма по индивидуальному дизайну.\n\nОставшуюся сумму необходимо оплатить перед отправкой готового изделия.",
      icon: CreditCard
    },
    {
      id: 3,
